"""The 30 referential/control scenario triples shared by attn_export3.py (MLX) and
attn_export3_torch.py (CPU/torch). Each entry: (category, turn-1 fact, referential
turn-2 [omits the needed value], control turn-2 [includes it])."""
