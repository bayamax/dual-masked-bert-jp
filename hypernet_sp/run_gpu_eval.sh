#!/bin/bash
# GPU evaluation job — GPUEVAL_V6. History: V1 wrong-wheel/no-fft_hf; V2 torch 2.11
...
{ echo "GPUEVAL_V6 start $(date -u)"; nvidia-smi --query-gpu=name,memory.total,driver_version --format=csv; \
...
push_stage "env ready (GPUEVAL_V6)"
